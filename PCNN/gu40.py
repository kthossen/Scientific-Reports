...
import csv
data = [[40,get_rmse(test_x, test_y),get_mae(test_x, test_y),mape,r2,"Guting"]]
file = open('Guting.csv', 'a+', newline ='')

with file:    
    write = csv.writer(file)
    write.writerows(data)
dfa47= pd.read_csv("Guting.csv")
dfa47
