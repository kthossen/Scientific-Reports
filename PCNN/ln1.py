...
def get_X_and_Y(table, station_name = 'Linkou'):
    table = table[table.SiteEngName =='Linkou']
...
train14_x, train14_y = get_X_and_Y(df_14, station_name = 'Linkou')
train15_x, train15_y = get_X_and_Y(df_15, station_name = 'Linkou')
train16_x, train16_y = get_X_and_Y(df_16, station_name = 'Linkou')
train17_x, train17_y = get_X_and_Y(df_17, station_name = 'Linkou')
train18_x, train18_y = get_X_and_Y(df_18, station_name = 'Linkou')
train19_x, train19_y = get_X_and_Y(df_19, station_name = 'Linkou')
train20_x, train20_y = get_X_and_Y(df_20, station_name = 'Linkou')
...
import csv
row_list = [["HR","RMSE","MAE","MAPE","R2","Site"],
             [1,get_rmse(test_x, test_y),get_mae(test_x, test_y),mape,r2,"Linkou"]]
with open('Linkou.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerows(row_list)
dfa471= pd.read_csv("Linkou.csv")
dfa471
