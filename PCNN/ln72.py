...
# Reshape for LSTM
reshaped = tf.reshape(dense, (-1, 1, 64))
...
import csv
data = [[72,get_rmse(test_x, test_y),get_mae(test_x, test_y),mape,r2,"Linkou"]]
file = open('Linkou.csv', 'a+', newline ='')

with file:    
    write = csv.writer(file)
    write.writerows(data)
dfa47= pd.read_csv("Linkou.csv")
dfa47
