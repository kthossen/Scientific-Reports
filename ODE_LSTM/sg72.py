...
def get_X_and_Y(table, station_name = 'Sanchong'):
    table = table[table.SiteEngName =='Sanchong']
...
train14_x, train14_y = get_X_and_Y(df_14, station_name = 'Sanchong')
train15_x, train15_y = get_X_and_Y(df_15, station_name = 'Sanchong')
train16_x, train16_y = get_X_and_Y(df_16, station_name = 'Sanchong')
train17_x, train17_y = get_X_and_Y(df_17, station_name = 'Sanchong')
train18_x, train18_y = get_X_and_Y(df_18, station_name = 'Sanchong')
train19_x, train19_y = get_X_and_Y(df_19, station_name = 'Sanchong')
train20_x, train20_y = get_X_and_Y(df_20, station_name = 'Sanchong')
...
def build_ode_lstm_model(input_shape):
    ...
    # LSTM Layer
    x = LSTM(72, return_sequences=True)(inputs)
...
import csv
data = [[72,rmse_score20,mae_score,"Sanchong"]]
