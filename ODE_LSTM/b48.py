...
def get_X_and_Y(table, station_name = 'Zhongshan'):
    table = table[table.SiteEngName =='Zhongshan']
...
train14_x, train14_y = get_X_and_Y(df_14, station_name = 'Zhongshan')
train15_x, train15_y = get_X_and_Y(df_15, station_name = 'Zhongshan')
train16_x, train16_y = get_X_and_Y(df_16, station_name = 'Zhongshan')
train17_x, train17_y = get_X_and_Y(df_17, station_name = 'Zhongshan')
train18_x, train18_y = get_X_and_Y(df_18, station_name = 'Zhongshan')
train19_x, train19_y = get_X_and_Y(df_19, station_name = 'Zhongshan')
train20_x, train20_y = get_X_and_Y(df_20, station_name = 'Zhongshan')
...
checkpoint_path = "Zhongshan48.h5"
...
import csv
data = [[48,rmse_score20,mae_score,"Zhongshan"]]
file = open('Zhongshan.csv', 'a+', newline ='')

# writing the data into the file
with file:    
    write = csv.writer(file)
    write.writerows(data)
dfa47= pd.read_csv("Zhongshan.csv")
dfa47
